...
sed -i.bak -e "s%^address = \"tcp://0.0.0.0:1317\"%address = \"tcp://0.0.0.0:${COREUM_PORT}317\"%; s%^address = \":8080\"%address = \":${COREUM_PORT}080\"%; s%^address = \"0.0.0.0:9090\"%address = \"0.0.0.0:${COREUM_PORT}090\"%; s%^address = \"0.0.0.0:9091\"%address = \"0.0.0.0:${COREUM_PORT}091\"%" $HOME/.core/coreum-testnet-1/config/app.toml
